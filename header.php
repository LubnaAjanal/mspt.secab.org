            ...
            <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Governance</span> <i
                                    class="bi bi-chevron-down toggle-dropdown"></i></a>
                            <ul>
                                <li><a href="https://mspt.secab.org/pdf/1.Governing%20council.pdf">Governing Council</a>
                                </li>
                                <li><a href="https://mspt.secab.org/pdf/2.Organization_Structure.pdf">Organization
                                        Structure</a></li>
                                <li><a href="../pages/clg_committe.php">College Committees</a></li>
                                <li><a href="../pages/approval_letter.php">Approval Letters</a></li>
                                <li class="dropdown"><a href="#"><span>Rules and Regulation</span> <i
                                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                                    <ul>
                                        <li><a
                                                href="https://mspt.secab.org/pdf/Student%20rules%20and%20regulations.pdf">Student's
                                                Rules</a></li>
                                        <li><a href="https://mspt.secab.org/pdf/Service%20rules.pdf">Service Rules</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Departments</span> <i
                            ...
                            <ul>
                                <li>
                                    <a href="../departments/basic_science.php?department=Basic%20Science">Basic
                                        Science</a>
                                </li>
                                <li>
                                    <a href="../departments/civil.php?department=Civil%20Engineering">Civil
                                        Engineering</a>
                                </li>
                                <li>
                                    <a
                                        href="../departments/computer_science.php?department=Computer%20Science%20Engineering">Computer
                                        Science & Engineering</a>
                                </li>
                                <li>
                                    <a
                                        href="../departments/electrical_electronics.php?department=Electrical%20Electronics%20Engineering">Electrical
                                        & Electronics Engineering</a>
                                </li>
                                <li>
                                    <a
                                        href="../departments/electronics_communication.php?department=Electronics%20Communication%20Engineering">Electronics
                                        & Communication Engineering</a>
                                </li>
                                <li>
                                    <a href="../departments/mechanical.php?department=Mechanical%20Engineering">Mechanical
                                        Engineering</a>
                                </li>
                                <li>
                                    <a
                                        href="../departments/apparel_design.php?department=Apparel%20Design%20Fabrication%20Technology">Apparel
                                        Design & Fabrication Technology</a>
                                </li>
                                <li>
                                    <a href="../departments/commercial_practice.php?department=Commercial%20Practice">Commercial
                                        Practice</a>
                                </li>
                            </ul>

                        </li>
                        <li class="dropdown"><a href="#"><span>Activities</span> <i
                                    class="bi bi-chevron-down toggle-dropdown"></i></a>
                            <ul>
                                <li class="dropdown"><a href="#"><span>National/International Days</span> <i
                                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                                    <ul>
